...
members_table = Table(
    ...
    Column("provinsi", String(255), nullable=True),
    Column("kota", String(255), nullable=True),
    Column("kecamatan", String(255)),
    Column("kelurahan", String(255)),
    Column("alamat_lengkap", Text, nullable=True),
    Column("nomor_whatsapp", String(20), nullable=False),
    Column("jenis_kelamin", CHAR(1), nullable=True),
    Column("tanggal_lahir", Date, nullable=True),
    Column("pendidikan_terakhir", Integer, nullable=True),
